...
export const metadata: Metadata = {
  ...
  description: "Explore JustBeCause Network pricing plans for NGOs. Access skilled candidates (impact agents), smart matching, and unlimited project postings. Start free — upgrade when you need more.",
