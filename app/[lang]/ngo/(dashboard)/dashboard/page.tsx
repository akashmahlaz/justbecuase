          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{dict.ngo?.dashboard?.subtitle || "Manage your jobs and connect with skilled candidates."}</p>
                                  ...
                                  <HoverCard>
                                      ...
                                      >
                                        ...
                                        <div className="flex-1 min-w-0">
                                          <p className="text-sm font-medium text-foreground truncate">
                                            {application.volunteerProfile?.name || "Candidate"}
                                          </p>
                                    ...
                                    <HoverCardContent className="w-72">
                                      <div className="flex gap-3">
                                        ...
                                        <div>
                                          <p className="text-sm font-semibold">{application.volunteerProfile?.name || "Candidate"}</p>
              ...
              <Card>
                ...
                <CardContent>
                  {recommendedVolunteers.length === 0 ? (
                    <div className="text-center py-6">
                      <Users className="h-8 w-8 text-muted-foreground mx-auto mb-2" />
                      <p className="text-sm text-muted-foreground">{dict.ngo?.dashboard?.noMatchingAgents || "No matching candidates yet"}</p>
                          ...
                          <HoverCard>
                            <HoverCardTrigger asChild>
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  <p className="text-sm font-medium text-foreground truncate">
                                    {match.volunteer.name || "Candidate"}
                                  </p>
                                  <p className="text-xs text-muted-foreground truncate">
                ...
                <CardContent className="space-y-2">
                  ...
                  <Button asChild variant="outline" className="w-full justify-start" size="sm">
                    <Link href="/ngo/find-talent">
                      ...
                      {dict.ngo?.dashboard?.browseImpactAgents || "Browse Candidates"}
                    </Link>
                  </Button>
                  <Button asChild variant="outline" className="w-full justify-start" size="sm">
                  ...
                  {subscriptionStatus?.plan === "free" ? (
                    <>
                      ...
                      <div className="p-4 rounded-lg bg-muted/50 border border-yellow-200">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {dict.ngo?.dashboard?.upgradeToPro || "Upgrade to Pro to unlock candidate profiles"}
                        </p>
                      </div>
                      <div className="p-3 bg-primary/5 rounded-lg border border-primary/20">
                        ...
                        <p className="text-xs text-muted-foreground mb-3">
                          {dict.ngo?.dashboard?.viewContactDetails || "View contact details of any candidate"}
                        </p>
                    ...
                    <div className="p-4 rounded-lg bg-linear-to-br from-primary/10 to-secondary/10 border border-primary/20">
                      ...
                      <p className="text-sm text-muted-foreground">
                        {dict.ngo?.dashboard?.unlimitedUnlocks || "Unlimited candidate profile unlocks"}
                      </p>
