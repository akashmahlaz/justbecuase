              ...
              <div className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {dict.ngo?.settings?.selectSkillsDesc || "Select skills your organization typically needs from candidates (impact agents)"}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <SkillSelector
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {dict.ngo?.settings?.selectCausesDesc || "Select causes to get matched with relevant candidates (impact agents)"}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {dict.ngo?.settings?.publicProfileDesc || "Allow candidates (impact agents) to see your organization profile"}
                        </p>
                      </div>
                      <Switch
