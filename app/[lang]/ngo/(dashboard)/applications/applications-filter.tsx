      ...
      <Card>
        <CardContent className="py-12 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            {dict.ngo?.applications?.noApplicationsDesc || "When candidates (impact agents) apply to your jobs, they will appear here."}
          </p>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 mb-2">
                            <div>
                              <h3 className="font-semibold text-foreground">
                                {application.volunteerProfile?.name || (dict.ngo?.common?.impactAgent || "Candidate (Impact Agent)")}
                              </h3>
                              <p className="text-sm text-muted-foreground">
