...
export default function ForVolunteersPage() {
  ...
  const benefits = [
    ...
    { icon: Award, title: v.benefitRecognizedTitle || "Get Recognized", description: v.benefitRecognizedDesc || "Earn badges, testimonials, and track your impact with our comprehensive candidate profiles." },
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
                ...
                <div className="flex flex-wrap gap-4">
                  <Button asChild size="lg" className="bg-primary hover:bg-primary/90">
                    <LocaleLink href="/auth/signup">
                      {v.registerNow || "Candidates – Register Now"}
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                {v.exchangeSubtitle || "Candidates (Professionals): Your \"Time\" is the new currency."}
              </p>
            </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-foreground mb-4">{v.whyBecomeTitle || "Why Become an Candidate?"}</h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">{v.storiesTitle || "Candidate Stories"}</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              {v.storiesSubtitle || "Hear from candidates who have made a difference through our platform"}
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {(testimonials as any[])
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">{v.faqSubtitle || "Everything you need to know about becoming an candidate"}</p>
          </div>
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg opacity-90 max-w-2xl mx-auto mb-8">
            {v.ctaPara || "Join our community of skilled candidates and start contributing to causes you care about today."}
          </p>
