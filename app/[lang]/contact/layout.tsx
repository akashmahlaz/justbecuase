...
export const metadata: Metadata = {
  ...
  description: "Get in touch with the JustBeCause Network team. We're here to help NGOs, candidates (impact agents), and partners. Send us a message or reach out on social media.",
